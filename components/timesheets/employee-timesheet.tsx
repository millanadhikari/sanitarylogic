...
export function EmployeeTimesheet({ timesheetId, employees, onClose }: { timesheetId: Id<"employeeTimesheets">; employees: TimesheetEmployee[]; onClose: () => void }) {
  ...
  const submitTimesheet = useMutation(api.timesheets.submit); const approveTimesheet = useMutation(api.timesheets.approve); const rejectTimesheet = useMutation(api.timesheets.reject); const reopenTimesheet = useMutation(api.timesheets.reopen);
